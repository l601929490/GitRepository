...
public interface ApplyMessageDao {
	...
	@Insert("insert into apply_message (apply_message_patriarch,apply_message_phone,apply_message_time,school_id,apply_message_count) "
			+ "values (#{applyMessagePatriarch},#{applyMessagePhone},#{applyMessageTime},#{schoolId},#{applyMessageCount})")
