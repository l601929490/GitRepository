...
@RestController
public class XqLearningOutcomesController {

//	@Autowired
//	private XqLearningOutcomesService service;
//	
//	@PostMapping("/applet/addXqLearningOutcomes")
//	public Map<String, Object> addXqLearningOutcomes(@RequestBody List<XqLearningOutcomes> outcomes) {
