...
public class ApplyController {
	...
	@PostMapping("/addApplyDefaultImg")
	public Map<String, Object> addApplyDefaultImg(@RequestBody applyDefaultImg applyDefaultImg){
		return service.addApplyDefaultImg(applyDefaultImg);
	}
	
	@GetMapping("/queryApplyDefaultImg")
	public Map<String, Object> queryApplyDefaultImg(Integer schoolId){
		return service.queryApplyDefaultImg(schoolId);
	}
