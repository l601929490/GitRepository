...
public interface CompanyDao {
	...
	@Insert("INSERT INTO `company`( `company_name`, `company_campus`, `company_creation_time`, `company_charge`, `company_principal`, `company_principal_phone`, company_creator,company_editor,company_edit_session,company_app_id,company_app_secret,wx_show_school_id,company_qrcode,start_time,end_time) "
			+ "VALUES ( #{companyName}, #{companyCampus}, #{companyCreationTime}, #{companyCharge}, #{companyPrincipal}, #{companyPrincipalPhone},#{companyCreator},#{companyEditor},#{companyEditSession},#{companyAppId},#{companyAppSecret},#{wxShowSchoolId},#{companyQrcode},#{startTime},#{endTime});")
